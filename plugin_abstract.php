...
abstract class PluginAbstract {
	...
	*/
	...
	protected function plugin_options_delete () {
		PluginUtils::_delete_option ( $this->plugin_constant, $this->network );
	...
	protected function plugin_options_read () {
		$options = PluginUtils::_get_option ( $this->plugin_constant, $this->network );
	...
	protected function plugin_options_save ( $activating = false ) {
		...
		PluginUtils::_update_option (  $this->plugin_constant , $this->options, $this->network );
	}
